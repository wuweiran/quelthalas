...
pub struct Tokens {
    ...
    pub color_neutral_background1_selected: D2D1_COLOR_F,
    ...
    pub color_brand_foreground1: D2D1_COLOR_F,
    pub color_brand_background2: D2D1_COLOR_F,
    pub color_brand_background_inverted_hover: D2D1_COLOR_F,
    pub color_brand_background_inverted_selected: D2D1_COLOR_F,
    pub color_brand_background_inverted_pressed: D2D1_COLOR_F,
    pub color_brand_foreground_on_light_hover: D2D1_COLOR_F,
    pub color_brand_foreground_on_light_pressed: D2D1_COLOR_F,
    pub color_status_warning_foreground3: D2D1_COLOR_F,
    ...
    pub color_brand_foreground_link_hover: D2D1_COLOR_F,
    pub color_brand_foreground_link_pressed: D2D1_COLOR_F,
    pub color_compound_brand_background: D2D1_COLOR_F,
    pub color_compound_brand_background_hover: D2D1_COLOR_F,
    pub color_compound_brand_background_pressed: D2D1_COLOR_F,
    pub color_compound_brand_stroke: D2D1_COLOR_F,
    pub color_compound_brand_stroke_hover: D2D1_COLOR_F,
    pub color_compound_brand_stroke_pressed: D2D1_COLOR_F,
    pub color_compound_brand_foreground1: D2D1_COLOR_F,
    pub color_compound_brand_foreground1_hover: D2D1_COLOR_F,
    pub color_compound_brand_foreground1_pressed: D2D1_COLOR_F,
    ...
    pub color_neutral_foreground1_static: D2D1_COLOR_F,
    pub color_neutral_foreground_on_brand: D2D1_COLOR_F,
    pub color_neutral_foreground_inverted: D2D1_COLOR_F,
    pub color_neutral_foreground2: D2D1_COLOR_F,
    pub color_neutral_foreground2_brand_hover: D2D1_COLOR_F,
    pub color_neutral_foreground2_brand_pressed: D2D1_COLOR_F,
    pub color_neutral_foreground3: D2D1_COLOR_F,
    pub color_neutral_foreground3_hover: D2D1_COLOR_F,
    pub color_neutral_foreground3_pressed: D2D1_COLOR_F,
    ...
    pub color_subtle_background_selected: D2D1_COLOR_F,
    ...
    pub color_neutral_stroke2: D2D1_COLOR_F,
    pub color_neutral_stroke3: D2D1_COLOR_F,
    pub color_brand_stroke1: D2D1_COLOR_F,
    pub color_neutral_stroke_on_brand: D2D1_COLOR_F,
    pub color_neutral_stroke_accessible: D2D1_COLOR_F,
    pub color_neutral_stroke_accessible_hover: D2D1_COLOR_F,
    pub color_neutral_stroke_accessible_pressed: D2D1_COLOR_F,
    ...
    pub font_size_base600: f32,
    pub font_size_base700: f32,
    pub font_size_base800: f32,
    ...
    pub spacing_vertical_xxs: f32,
    pub spacing_vertical_xs: f32,
...
impl Tokens {
    fn web_light() -> Self {
        Tokens {
            ...
            color_neutral_background1_selected: rgb!("#e0e0e0"),
            ...
            color_brand_foreground1: rgb!("#0f6cbd"),
            color_brand_background2: rgb!("#ebf3fc"),
            color_brand_background_inverted_hover: rgb!("#eff6fc"),
            color_brand_background_inverted_selected: rgb!("#deecf9"),
            color_brand_background_inverted_pressed: rgb!("#c7e0f4"),
            color_brand_foreground_on_light_hover: rgb!("#106ebe"),
            color_brand_foreground_on_light_pressed: rgb!("#004c87"),
            color_status_warning_foreground3: rgb!("#bc4b09"),
            color_status_danger_foreground1: rgb!("#b10e1c"),
            color_status_success_foreground1: rgb!("#0e700e"),
            ...
            color_brand_foreground_link_hover: rgb!("#0f548c"),
            color_brand_foreground_link_pressed: rgb!("#0c3b5e"),
            color_compound_brand_background: rgb!("#0f6cbd"),
            color_compound_brand_background_hover: rgb!("#115ea3"),
            color_compound_brand_background_pressed: rgb!("#0f548c"),
            color_compound_brand_stroke: rgb!("#0f6cbd"),
            color_compound_brand_stroke_hover: rgb!("#115ea3"),
            color_compound_brand_stroke_pressed: rgb!("#0f548c"),
            color_compound_brand_foreground1: rgb!("#0f6cbd"),
            color_compound_brand_foreground1_hover: rgb!("#115ea3"),
            color_compound_brand_foreground1_pressed: rgb!("#0f548c"),
            ...
            color_neutral_foreground1_static: rgb!("#242424"),
            color_neutral_foreground_on_brand: rgb!("#ffffff"),
            color_neutral_foreground_inverted: rgb!("#ffffff"),
            color_neutral_foreground2: rgb!("#424242"),
            color_neutral_foreground2_brand_hover: rgb!("#0f6cbd"),
            color_neutral_foreground2_brand_pressed: rgb!("#0f548c"),
            color_neutral_foreground3: rgb!("#616161"),
            color_neutral_foreground3_hover: rgb!("#424242"),
            color_neutral_foreground3_pressed: rgb!("#333333"),
            color_neutral_foreground_disabled: rgb!("#bdbdbd"),
            color_subtle_background_hover: rgb!("#f5f5f5"),
            color_subtle_background_pressed: rgb!("#e0e0e0"),
            color_subtle_background_selected: rgb!("#e0e0e0"),
            ...
            color_neutral_stroke3: rgb!("#f0f0f0"),
            color_brand_stroke1: rgb!("#0f6cbd"),
            color_neutral_stroke_on_brand: rgb!("#ffffff"),
            color_neutral_stroke_accessible: rgb!("#616161"),
            color_neutral_stroke_accessible_hover: rgb!("#575757"),
            color_neutral_stroke_accessible_pressed: rgb!("#4d4d4d"),
            ...
            font_size_base600: 24f32,
            font_size_base700: 28f32,
            font_size_base800: 32f32,
            ...
            spacing_vertical_xxs: 2f32,
            spacing_vertical_xs: 4f32,
            ...
            curve_easy_ease_max: [0.8, 0.0, 0.2, 1.0],
    ...
    fn web_dark() -> Self {
        Tokens {
            ...
            color_neutral_background1_hover: rgb!("#3d3d3d"),
            color_neutral_background1_pressed: rgb!("#1f1f1f"),
            color_neutral_background1_selected: rgb!("#1f1f1f"),
            ...
            color_brand_foreground1: rgb!("#479ef5"),
            color_brand_background2: rgb!("#092b50"),
            color_brand_background_inverted_hover: rgb!("#eff6fc"),
            color_brand_background_inverted_selected: rgb!("#deecf9"),
            color_brand_background_inverted_pressed: rgb!("#c7e0f4"),
            color_brand_foreground_on_light_hover: rgb!("#106ebe"),
            color_brand_foreground_on_light_pressed: rgb!("#004c87"),
            color_status_warning_foreground3: rgb!("#d67d3e"),
            color_status_danger_foreground1: rgb!("#dc626d"),
            color_status_success_foreground1: rgb!("#54b054"),
            color_brand_background_hover: rgb!("#0f6cbd"),
            color_brand_stroke2_contrast: rgb!("#0f6cbd"),
            color_brand_background_pressed: rgb!("#0c3b5e"),
            color_brand_foreground_link: rgb!("#479ef5"),
            color_brand_foreground_link_hover: rgb!("#62abf5"),
            color_brand_foreground_link_pressed: rgb!("#2886de"),
            color_compound_brand_background: rgb!("#479ef5"),
            color_compound_brand_background_hover: rgb!("#62abf5"),
            color_compound_brand_background_pressed: rgb!("#2886de"),
            color_compound_brand_stroke: rgb!("#479ef5"),
            color_compound_brand_stroke_hover: rgb!("#62abf5"),
            color_compound_brand_stroke_pressed: rgb!("#2886de"),
            color_compound_brand_foreground1: rgb!("#479ef5"),
            color_compound_brand_foreground1_hover: rgb!("#62abf5"),
            color_compound_brand_foreground1_pressed: rgb!("#2886de"),
            ...
            color_neutral_foreground1_static: rgb!("#242424"),
            color_neutral_foreground_on_brand: rgb!("#ffffff"),
            color_neutral_foreground_inverted: rgb!("#242424"),
            color_neutral_foreground2: rgb!("#d6d6d6"),
            color_neutral_foreground2_brand_hover: rgb!("#479ef5"),
            color_neutral_foreground2_brand_pressed: rgb!("#2886de"),
            color_neutral_foreground3: rgb!("#adadad"),
            color_neutral_foreground3_hover: rgb!("#d6d6d6"),
            color_neutral_foreground3_pressed: rgb!("#ebebeb"),
            color_neutral_foreground_disabled: rgb!("#5c5c5c"),
            color_subtle_background_hover: rgb!("#383838"),
            color_subtle_background_pressed: rgb!("#2e2e2e"),
            color_subtle_background_selected: rgb!("#383838"),
            color_neutral_stroke1: rgb!("#666666"),
            color_neutral_stroke1_hover: rgb!("#757575"),
            color_neutral_stroke1_pressed: rgb!("#6b6b6b"),
            color_neutral_stroke2: rgb!("#525252"),
            color_neutral_stroke3: rgb!("#454545"),
            color_brand_stroke1: rgb!("#479ef5"),
            color_neutral_stroke_on_brand: rgb!("#ffffff"),
            color_neutral_stroke_accessible: rgb!("#adadad"),
            color_neutral_stroke_accessible_hover: rgb!("#bdbdbd"),
            color_neutral_stroke_accessible_pressed: rgb!("#b3b3b3"),
            stroke_width_thin: 1.0,
            font_family_base: w!("Segoe UI"),
            font_weight_regular: DWRITE_FONT_WEIGHT_REGULAR,
            font_weight_semibold: DWRITE_FONT_WEIGHT_SEMI_BOLD,
